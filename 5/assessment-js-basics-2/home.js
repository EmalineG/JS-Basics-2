...
const canWeDeliverTwo = (zipCode) => {
    if(deliveryAreaZipCodes.includes(zipCode)){
        return "We can deliver to your area! :)"
    } else{
        return "You are outside of our delivery area :("
    }
}
...
// replace ... first value what to replace, second value what to replace with
...
//check whats currently showing
console.log(deals[1].desc)

// trim takes off whitespace
