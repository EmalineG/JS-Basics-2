...
let string = 'I am a Javascript ninja'
...
const compareNums = (num1, num2) => { (num1 > num2) ? console.log(num1 + " is bigger") : console.log(num2 + " is bigger")}
...
const exclaimThree = (klsjafd) => klsjafd.toUpperCase()
...
function nameCheck(theName){
  ...
  }else if(theName == "Bryan"){
    return "Hey Bryan!"
  } else{
    return "Cool name, " + theName
  }
}
...
// //CODE HERE
yellThis = loudString(sampleString)

function loudString(str){
...
console.log(emailCheck('emgayhartgmail.com'))
